import { forceUpdate, getRenderingRef } from '@rindo/core';
...
export const rindoSubscription = <T>(): Subscription<T> => {
  if (typeof getRenderingRef !== 'function') {
    // If we are not in a rindo project, we do nothing.
    // This function is not really exported by @rindo/core.
    return {};
  }
